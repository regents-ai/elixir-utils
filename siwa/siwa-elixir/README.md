...
Use it as the shared implementation behind the shared SIWA contract in the Regent CLI repo at `docs/regent-services-contract.openapiv3.yaml`. Product repos may mount routes or adapters, but they should not present themselves as the owner of shared SIWA behavior.
